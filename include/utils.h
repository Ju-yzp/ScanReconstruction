...
//     bool smoothing, bool flipNormals, Eigen::Vector3f lightSource, cv::Vec2i point, float
//     voxelSize, Eigen::Vector4f* pointRay, cv::Size2i imgSize, Eigen::Vector3f& output_normal,
//     float& angle) { Eigen::Vector4f rayPoints[4]; if (smoothing) {
